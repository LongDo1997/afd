<?php 
    $pos = strpos($data->summary, ' end_Of_The_Link, ');
    if($pos==false){
        $summarytitle= $data->summary;
        $icon="";
    }else{
        $summary = explode(' end_Of_The_Link, ',$data->summary);
                   ...
                   <div class="row">
                       <div class="col-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" id="" class="form-control" value="{{$icon}}" placeholder="Nhập mã icon" aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                ...
                                @else
                                <textarea type="text" name="summary" id="editor-ckeditor2" placeholder="Nhập mô tả chung"  class="form-control"  aria-describedby="helpId">{{$summarytitle}}</textarea>
                                @endif
                                @error('summary')
                                <small id="helpId" class="text-danger">{{$message}}</small>
                                @enderror
